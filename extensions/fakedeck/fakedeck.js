...
function initialise (app, host, port, heartbeat)
{
    ...
    app.use("/fakedeck/", express.static(__dirname + "/public"));
    app.use("/fakedeck/scripts", express.static(__dirname + "/views/scripts"));

    config.dataCenterApp = app
    try
    {
        config.dataCenterApp.get("/fakedeck", function (req, res)
        {
