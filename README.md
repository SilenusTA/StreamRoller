...
# Take control of your stream (```5,900,860``` Possibilities)

No other software out there gives you the same level of control over your stream in one App

No. of possible combinations for a single trigger->action ```5,900,860```

No. of user configurable Trigger / Action available: ```5,312```
